class NotesController < ApplicationController
  ...
  def create
    ...
    if @note.save
      ...
      redirect_to polymorphic_path(@notable), notice: "Note was successfully created."
    else
  ...
  def update
    if @note.update(note_params)
      redirect_to polymorphic_path(@notable), notice: "Note was successfully updated."
    else
  ...
  def destroy
    @note.destroy
    redirect_to polymorphic_path(@notable), notice: "Note was successfully deleted."
  end
